...
cdef class OrderBookStrategy(StrategyBase):
    ...
    def format_status(self) -> str:
        ...
        for market_info in self._market_infos.values():
            ...
            self.log_with_clock(logging.INFO, str(markets_df.columns))
            self.log_with_clock(logging.INFO, str(markets_df.values))
            ...
            lines.extend(["", "  User's Asset Balance:"] + ["    " + base_asset_amt + "    " + market_info.base_asset] +
